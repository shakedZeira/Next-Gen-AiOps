      ...
      <div className="flex items-center justify-between flex-wrap gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            onClick={refreshAll}
            disabled={loading}
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-gray-100 text-gray-700 text-sm hover:bg-gray-200 transition-colors disabled:opacity-50"
          >
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="bg-white rounded-lg border p-4">
            <div className="flex items-center justify-between">
              <div className="text-xs text-gray-500 uppercase tracking-wide">Total Traps</div>
          ...
          <div className="bg-white rounded-lg border p-4">
            <div className="flex items-center justify-between">
              <div className="text-xs text-gray-500 uppercase tracking-wide">Alerts Published</div>
          ...
          <div className="bg-white rounded-lg border p-4">
            <div className="flex items-center justify-between">
              <div className="text-xs text-gray-500 uppercase tracking-wide">By Severity</div>
          ...
          <div className="bg-white rounded-lg border p-4">
            <div className="flex items-center justify-between">
              <div className="text-xs text-gray-500 uppercase tracking-wide">Top Sources</div>
      ...
      <div className="flex gap-3 flex-wrap">
        <div className="flex items-center gap-2">
          ...
          <input
            ...
            className="px-3 py-1.5 rounded-lg border border-gray-300 text-sm font-mono focus:ring-2 focus:ring-primary-500 w-44"
          />
        </div>
        <div className="flex items-center gap-2">
        ...
        <div className="flex items-center gap-2">
          <label className="text-sm text-gray-500">OID Type:</label>
          <select
            value={oidFilter}
  ...
  if (loading) {
    return (
      <div className="bg-white rounded-xl border overflow-hidden">
        <div className="p-8 text-center text-gray-500">Loading SNMP traps...</div>
      </div>
    );
  }
          ...
          <tbody className="divide-y divide-gray-100">
            {traps.map((trap, idx) => (
              <tr
                ...
                className={`font-mono text-xs hover:bg-gray-50 transition-colors ${
              ...
              >
                ...
                <td className="px-4 py-2.5 whitespace-nowrap">
                  <div className="flex items-center gap-1.5">
                    <span className="text-gray-900 font-semibold">{trap.device_name}</span>
                    {trap.ci_matched && (
                      <span
                ...
                <td className="px-4 py-2.5 whitespace-nowrap">
                  <span className="text-gray-900 font-semibold">{trap.trap_name}</span>
