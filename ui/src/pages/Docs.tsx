      ...
      <main ref={mainRef} className="flex-1 overflow-y-auto p-8">
        <div className="max-w-4xl mx-auto space-y-16">
          ...
          <section id="overview">
            ...
            <pre className="bg-gray-800 p-4 rounded-xl text-sm text-gray-300 overflow-x-auto mb-6">{`
┌─────────────┐     ┌──────────────┐     ┌──────────────┐
...
└─────────────┘     └──────┬───────┘     └──────────────┘
        ...
        └───────────┘ │ (8005) │ └──────────┘
          ...
          <section id="dashboard">
            ...
            <p className="text-gray-300 mb-4">The landing page showing system-wide health.</p>
          ...
          <section id="cmdb-explorer">
            ...
            <p className="text-gray-300 mb-4">The core topology visualization tool with 4 view modes.</p>
          ...
          <section id="geo-map">
            ...
            <p className="text-gray-300 mb-4">Leaflet-based dark-theme map showing infrastructure geographically.</p>
          ...
          <section id="noc-alerts">
            ...
            <p className="text-gray-300 mb-4">Real-time alert management interface.</p>
          ...
          <section id="ai-chatbot">
            ...
            <p className="text-gray-300 mb-4">AI-powered assistant for infrastructure queries.</p>
            <h3 className="text-lg font-semibold text-white mb-2">How to Use</h3>
            <p className="text-gray-300 mb-2">Type natural language questions about your infrastructure:</p>
            <ul className="text-gray-300 space-y-2 list-disc list-inside mb-4">
            ...
            <p className="text-gray-300 mb-4">Quick-start buttons for common queries. Click any to auto-send.</p>
          ...
          <section id="dc-explorer">
            ...
            <p className="text-gray-300 mb-4">Physical infrastructure visualization across 6 DC rooms.</p>
          ...
          <section id="agent-monitor">
            ...
            <p className="text-gray-300 mb-4">LLM usage and model health tracking.</p>
            ...
            <p className="text-gray-300">Per-model metrics: request count, error rate, P50/P99 latency, tokens per minute, cost per hour, status (healthy/degraded/down).</p>
          </section>

          {/* === Section 10: System Health === */}
          <section id="system-health">
            <h2 className="text-2xl font-bold text-white mb-4">System Health</h2>
            <p className="text-gray-300 mb-4">Infrastructure component monitoring.</p>
            ...
            <ul className="text-gray-300 space-y-2 list-disc list-inside">
              ...
              <li><span className="text-gray-400 font-medium">Gray:</span> No data available</li>
            </ul>
          </section>
          ...
          <section id="api-reference">
            ...
            <pre className="bg-gray-800 p-3 rounded-xl text-sm text-gray-300 mb-4">{`POST /auth/login          - Get JWT token
POST /auth/refresh        - Refresh token
GET  /auth/me             - Current user info`}</pre>
            
            <h3 className="text-lg font-semibold text-white mb-2">CMDB</h3>
            <pre className="bg-gray-800 p-3 rounded-xl text-sm text-gray-300 mb-4">{`GET    /api/v1/cmdb/ci                     - List all CIs
...
GET    /api/v1/cmdb/impact/{ci_id}         - Downstream impact analysis`}</pre>
            ...
            <pre className="bg-gray-800 p-3 rounded-xl text-sm text-gray-300 mb-4">{`GET    /api/v1/cmdb/dc/rooms              - List rooms
...
GET    /api/v1/cmdb/dc/racks/{id}/equipment - Get equipment in rack`}</pre>
            ...
            <pre className="bg-gray-800 p-3 rounded-xl text-sm text-gray-300 mb-4">{`GET    /api/v1/alerts                     - List alerts
...
POST   /api/v1/alerts/{id}/resolve        - Resolve alert`}</pre>
            ...
            <pre className="bg-gray-800 p-3 rounded-xl text-sm text-gray-300">{`POST   /api/v1/chatbot/chat               - Send message
...
POST   /api/v1/chatbot/approvals/{id}     - Approve/reject`}</pre>
          ...
          <section id="deployment">
            ...
            <pre className="bg-gray-800 p-3 rounded-xl text-sm text-gray-300 mb-4">docker compose up -d</pre>
            ...
            <pre className="bg-gray-800 p-3 rounded-xl text-sm text-gray-300 mb-4">JWT_SECRET_KEY=your-secret-key
...
REDIS_PASSWORD=your-redis-password</pre>
            ...
            <pre className="bg-gray-800 p-3 rounded-xl text-sm text-gray-300">{`Check logs:    docker compose logs -f [service]
